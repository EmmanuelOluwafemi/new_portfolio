const workData = [
    {
        ...
        desc: `Building a job matching platform that helps recruiters ease the
                recruitment process and also pitch talents to companies.`,
        link: 'https://www.hoplacareers.online/',
    },
    {
        title: 'Repeefy',
        tech: 'React + Styled-components + Redux + framer-motion',
        desc: `Worked on the frontend of a fintech startup that automates payments.`,
        link: 'https://dashboard.repeefy.com/',
    },
    {
